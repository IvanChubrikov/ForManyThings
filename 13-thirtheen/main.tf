...
ansible_ssh_common_args='-o ProxyCommand="ssh -p 22 -W %h:%p -q ubuntu@${admin_instance} -o StrictHostKeyChecking=no"'root@ivan-ubuntu:/usr/git_repos/haproxy# cat /media/sf_ansible/cert.txt 
