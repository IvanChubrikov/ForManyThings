...
resource "terraform_data" "run_ansible" {
  ...
  provisioner "local-exec" {
    ...
    rm -rf /tmp/fetched
    ansible-playbook -i opensearch-playbook/inventories/opensearch/hosts opensearch-playbook/opensearch.yml --extra-vars "admin_password=Test@1111 kibanaserver_password=Test@1111 logstash_password=Test@1111"
    EOF
  }
}
